...
import { Menu, SubMenu, MenuItem, MenuSection } from '@/app/admin/@menu/vertical-menu'

// Hook Imports
import useVerticalNav from '@/app/admin/@menu/hooks/useVerticalNav'

// Styled Component Imports
import StyledVerticalNavExpandIcon from '@/app/admin/@menu/styles/vertical/StyledVerticalNavExpandIcon'

// Style Imports
import menuItemStyles from '@/app/admin/@core/styles/vertical/menuItemStyles'
import menuSectionStyles from '@/app/admin/@core/styles/vertical/menuSectionStyles'
    ...
    >
      ...
      >
        ...
        <MenuSection >
          ...
          <MenuItem href='/admin/app' icon={<i className='ri-home-line' />}>
            Dashboard
          </MenuItem>
          <MenuItem href='/admin/app/user' icon={<i className='ri-user-line' />}>
            User
          </MenuItem>
          <MenuItem href='/admin/app/proposal' icon={<i className='ri-file-list-line' />}>
            Proposals
          </MenuItem>

          {/* <MenuItem href='/transaction' icon={<i className='ri-exchange-line' />}>
  Transactions
</MenuItem> */}
          <MenuItem href='/admin/app/offers' icon={<i className='ri-price-tag-line' />}>
            Offers
          </MenuItem>
          <MenuItem href='/admin/app/promoCode' icon={<i className='ri-coupon-3-line' />}>
            Promo Codes
          </MenuItem>
