...
<p className=' font-inter font-semibold text-[30px] leading-[120%] tracking-[-0.75px] text-ruinedSmores'>Dashboard</p>
...
<button className='w-[99px] h-[36px] flex items-center justify-center font-inter font-medium text-[14px] leading-[142%] bg-[#18181B] rounded-[6px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border border-[#18181B] text-[#FAFAFA] hover:bg-transparent hover:text-[#18181B] transition duration-300 ease-in-out '>Download</button>
</div>
</div>
{/* tabs */}
          ...
          <div className="flex cursor-pointer">
            ...
            <button
              ...
              className={` text-sm font-medium rounded-[4px] leading-[20px] p-[4px_10px]  sm:p-[4px_12px]   ${
                navTab === "Analytics" ? "bg-white text-black" : "text-[#71717A]"
              }`}
            >
              Analytics
            </button>
            ...
            <button
              ...
              className={` text-sm font-medium rounded-[4px] leading-[20px] p-[4px_10px]  sm:p-[4px_12px]   ${
                navTab === "Notifications" ? "bg-white text-black" : "text-[#71717A]"
              }`}
            >
              Notifications
            </button>
