...
import { DownArrowIcon, DownArrowIcon2, WritingSidebarIcon } from "./Icon";

export default function WritingBeteDropDown() {
  return (
    <Disclosure>
      {({ open }) => (
        <>
          <Disclosure.Button className="w-full">
            ...
            >
              <span className={`w-fit h-fit  ${open ? " text-white" : ""}`}>
                <WritingSidebarIcon color={open ? "white" : "currentColor"} />
              </span>
              <div className="flex gap-2 items-center">
                ...
                <span className={` w-fit h-fit ${open ? "  -rotate-180" : ""}`}>
                  <DownArrowIcon color={open ? "white" : "currentColor"} />
                </span>
              </div>
            </div>
          </Disclosure.Button>
