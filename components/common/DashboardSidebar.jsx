...
const DashboardSidebar = ({ sidebar, setSidebar, setSelectedComponent, selectedComponent }) => {
  ...
  return (
    <div
      className={`sm:max-w-[260px] scrollbar_hide h-full overflow-hidden bg-[#e5e6e9] z-20 pb-4 relative w-full px-4 pt-6 max-lg:absolute max-sm:w-full duration-300 top-0 ${sidebar ? "left-0" : "max-lg:left-[-105%]"
        }`}
    >
      ...
      <div className="w-full h-full flex flex-col justify-between gap-12">
        <div className="flex flex-col h-[calc(100vh-200px)] overflow-auto scrollbar_hide gap-1 mt-2 lg:mt-[59px]">
          <button
            ...
            className={`py-[11px] px-3 rounded-[4px] max-w-[228px] w-full border border-[rgba(255,255,255,0.11)] ${isSelected("Home") ? "bg-[#002b42] text-white" : "bg-transparent group hover:bg-[#002b42]"
          ...
          <button
            ...
            className={`py-[11px] px-3 rounded-[4px] max-w-[228px] w-full border border-[rgba(255,255,255,0.11)] ${isSelected("AISearch") ? "bg-[#002b42] text-white" : "bg-transparent group hover:bg-[#002b42]"
          ...
          <button
            ...
            className={`py-[11px] px-3 rounded-[4px] max-w-[228px] w-full border border-[rgba(255,255,255,0.11)] ${isSelected("Proposals") ? "bg-[#002b42] text-white" : "bg-transparent group hover:bg-[#002b42]"
              } flex justify-between gap-3 items-center transition duration-300 ease-in-out`}
          >
            <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`py-[11px] px-3 rounded-[4px] max-w-[228px] w-full border border-[rgba(255,255,255,0.11)] ${isSelected("Plans") ? "bg-[#002b42] text-white" : "bg-transparent group hover:bg-[#002b42]"
              } flex gap-3 items-center transition duration-300 ease-in-out`}
          >
            <Iconify icon="mdi:clipboard-list-outline" />
          ...
          <button
            ...
            className={`py-[11px] px-3 rounded-[4px] max-w-[228px] w-full border border-[rgba(255,255,255,0.11)] ${isSelected("Profile") ? "bg-[#002b42] text-white" : "bg-transparent group hover:bg-[#002b42]"
              } flex gap-3 items-center transition duration-300 ease-in-out`}
          >
          ...
          <button
            ...
            className={`py-[11px] px-3 rounded-[8px] max-w-[228px] w-full border border-[rgba(255,255,255,0.11)] ${isSelected("Help") ? "bg-[#002b42] text-white" : "bg-transparent group hover:bg-[#002b42] hover:rounded-[4px]"
